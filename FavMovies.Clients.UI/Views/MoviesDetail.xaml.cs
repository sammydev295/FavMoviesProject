...
namespace FavMovies.Views
{
    ...
    public partial class MoviesDetail : PopupPage
    {
        #region Fields

        MoviesDetailViewModel ViewModel = App.Locator.MoviesDetail;
        ...
        public MoviesDetail(object film)
        {
            InitializeComponent();
            BindingContext = ViewModel;
            ViewModel.Film = film as MovieBO;
            NavigationPage.SetHasNavigationBar(this, false);
        }
